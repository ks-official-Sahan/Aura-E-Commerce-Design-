...
<head>
    ...
    <title>Advance Search | New Tech</title>
            ...
            <div class="col-12 bg-body mt-1 mb-2">
                <div class="row">
                    <div class="offset-lg-4 col-12 col-lg-4">
                        <div class="row g-3">
                            <div class="col-3">
                                <img src="resources/logo1.svg" class="p-2 my-3" style="height: 50px;">
                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="row g-1">
                                                        <div class="col-12 col-lg-6 d-grid">
                                                            <button class="btn btn-success fs" onclick="buyNow(0);">Buy Now</button>
                                                        </div>
                                                        <div class="col-12 col-lg-6 d-grid">
