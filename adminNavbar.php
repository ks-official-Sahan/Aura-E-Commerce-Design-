        ...
        <div class="container-fluid">
                ...
                <div class="row justify-content-lg-end justify-content-center">
                    <div class="col-8">
                        <div class="dropdown-center d-grid">
                            <button class="btn btn-light dropdown-toggle justify-content-end" type="button" data-bs-toggle="dropdown">
                            ...
                            <ul class="bg-white dropdown-menu w-100 dropdown-menu-lg-end dropdown-menu-start">
                                ...
                                <li><span class="fw-bold cursor-pointer dropdown-item" onclick="signOut();">Sign Out</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="offcanvas text-uppercase offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-header bg-white">
                    <h5 class="offcanvas-title text-info" id="offcanvasNavbarLabel">New Tech</h5>
                ...
                <div class="offcanvas-body bg-white">
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item"><a class="nav-link" href="recents&saved.php">Recents</a></li>
